...
const Profile = ({ setActiveSection }) => {
  ...
  const fetchProfile = async () => {
    ...
    try {
      ...
      if (staff) {
        ...
        if (staff.image) {
          setPreviewImage(`http://localhost:8080/api/files/uploads/${staff.image}`);
        }
      } else {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem('username', updatedStaff.username);
                    ...
                    <div className="profile-avatar-container text-center mb-4">
                      <div className="profile-avatar shadow">
                        {previewImage ? (
                          ...
                          <img src={`http://localhost:8080/api/files/uploads/${formData.image}`} alt="Profile" className="avatar-image" />
                        ) : (
                          <span className="avatar-initial">
                            {formData.username.charAt(0).toUpperCase()}
                          </span>
                      ...
                      <div className="mt-3">
                        <label htmlFor="imageUpload" className="btn btn-outline-primary btn-sm rounded-pill">
