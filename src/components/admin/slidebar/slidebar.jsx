...
const Sidebar = ({ activeSection, handleNavClick }) => {
  ...
  const Logout = () => {
    ...
    localStorage.removeItem('customer'); // Clear customer data on logout
    navigate('/');
  };
          ...
          <div className="mb-4">
            ...
            <ul className="nav flex-column">
              {[
                ...
                { href: '#customer-food-orders', icon: 'fa-utensils', text: 'Customer Food Orders', section: 'customer-food-orders', color: '#e67e22' },
