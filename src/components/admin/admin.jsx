    ...
    <>
      ...
      <div className="d-flex">
          ...
          <div>
            ...
            <nav className="mt-4 px-4">
              ...
              <div className="mb-4">
                ...
                <ul className="nav flex-column">
                  {[
                    { href: '#add-staff', icon: 'fa-user-plus', text: 'Add Staff', section: 'add-staff' },
                    { href: '#staff-details', icon: 'fa-list', text: 'Staff Details', section: 'staff-details' },
                    { href: '#hotel-manager', icon: 'fa-user-tie', text: 'Hotel Manager', section: 'hotel-manager' },
                    { href: '#restaurant-manager', icon: 'fa-utensils', text: 'Restaurant Manager', section: 'restaurant-manager' },
                  ].map(({ href, icon, text, section }) => (
              ...
              <div>
                ...
                <ul className="nav flex-column">
                  {[
                    { href: '#foods', icon: 'fa-utensils', text: 'Food Items', section: 'foods' },
                    { href: '#rooms', icon: 'fa-bed', text: 'Rooms', section: 'rooms' },
                    { href: '#ratings-reviews', icon: 'fa-star', text: 'Ratings & Reviews', section: 'ratings-reviews' },
                  ].map(({ href, icon, text, section }) => (
                    <li key={href} className="nav-item">
                      <a className={`nav-link ${activeSection === section && 'active'}`} 
                         href={href} 
        ...
        <main className="flex-grow-1 p-4">
          <div id="dashboard" className={activeSection !== 'dashboard' ? 'd-none' : ''}>
          ...
          <div id="add-staff" className={`mt-5 ${activeSection !== 'add-staff' ? 'd-none' : ''}`}>
          ...
          <TableSection
            ...
            isActive={activeSection === 'staff-details'}
          />
          <TableSection
            id="foods"
            title="Food Orders"
          ...
          <TableSection
            ...
            isActive={activeSection === 'ratings-reviews'}
          />
          {['hotel-manager', 'restaurant-manager'].map(id => (
            <div key={id} id={id} className={`mt-5 ${activeSection !== id ? 'd-none' : ''}`}>
